...
-- Substitua 'schema_name' pelo nome do schema desejado, ou remova o filtro para buscar em todos os schemas.
  ...
  pg_index as idx
    join pg_class as i
      ...
      join pg_indexes idxs
           ...
           and idxs.schemaname ilike 'schema_name' -- substitua pelo nome do schema ou remova para buscar em todos
